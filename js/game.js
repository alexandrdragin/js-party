...
define(function() {
  ...
  Game.prototype = {
    ...
    _pauseListener: function(evt) {
      if (evt.keyCode === 32) {
        evt.preventDefault();
        var needToRestartTheGame = this.state.currentStatus === Verdict.WIN || this.state.currentStatus === Verdict.FAIL;
     ...
     */
    _onKeyUp: function() {
      var keysPressed = Object.keys(this.state.keysPressed);
      keysPressed.forEach(function(keyName) {
        this.state.keysPressed[keyName] = false;
      }, this);
    },
